export default function AnimatedWaves() {
  return (
    <div className="absolute inset-0 overflow-hidden bg-[#181D2D]">
      ...
      {/* Wavy SVG overlay */}
      <svg
        className="absolute w-[200%] h-full bottom-0 left-0"
      ...
      >
        ...
        <path
          className="wave-1 origin-bottom"
          fill="rgba(36, 53, 85, 0.4)"
        ...
        {/* Mid-layer wave */}
        <path
          className="wave-2 origin-bottom"
          fill="rgba(26, 79, 107, 0.5)"
          d="M0,96L60,101.3C120,107,240,117,360,138.7C480,160,600,192,720,197.3C840,203,960,181,1080,160C1200,139,1320,117,1380,106.7L1440,96L1440,320L1380,320C1320,320,1200,320,1080,320C960,320,840,320,720,320C600,320,480,320,360,320C240,320,120,320,60,320L0,320Z"
        ></path>
        {/* Foreground dark wave */}
        <path
          className="wave-3 origin-bottom"
          fill="rgba(20, 29, 43, 0.8)"
          d="M0,256L80,240C160,224,320,192,480,192C640,192,800,224,960,234.7C1120,245,1280,235,1360,229.3L1440,224L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"
        ></path>
      </svg>
