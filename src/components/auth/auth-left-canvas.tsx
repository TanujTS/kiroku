...
export default function AuthLeftCanvas() {
  return (
    <div className="relative hidden lg:flex flex-col justify-between p-12 overflow-hidden bg-[#181D2D]">
        ...
        >
          <Link href="/" className="text-[#F1EBE4] font-heading font-bold tracking-tight text-3xl hover:text-white transition-colors">
            Kiroku
          </Link>
        </motion.div>
        ...
        <div className="relative z-10 max-w-lg mb-20 md:mb-32">
          ...
          >
            A quiet space for intentional reflection. Curate your thoughts in an environment designed for clarity and calm.
          </motion.p>
        </div>
    </div>
  );
