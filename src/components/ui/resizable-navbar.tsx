...
export const NavbarButton = ({
  ...
  const baseStyles =
    "px-4 py-2 rounded-md border border-border bg-background text-foreground text-sm font-bold relative cursor-pointer hover:-translate-y-0.5 transition duration-200 inline-block text-center";
