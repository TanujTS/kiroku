    ...
    return (
        <section className="relative w-screen h-screen flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 text-center flex flex-col gap-4 px-4">
                <h1 className="font-space text-7xl md:text-9xl font-bold tracking-tighter text-foreground">
                    Kiroku
                </h1>
                <p className="font-nunito text-lg md:text-xl font-light tracking-wide text-muted-foreground/80 leading-none">
